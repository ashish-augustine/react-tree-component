...
This is a React tree component depicting advanced drag-and-drop capabilities, enables toggling of different nodes (folders) & their sub nodes (sub folders). React Arborist Library is used here. 
